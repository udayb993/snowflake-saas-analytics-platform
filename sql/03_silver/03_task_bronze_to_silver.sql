...
CREATE OR REPLACE TASK SAAS_ANALYTICS.SILVER.TASK_TRANSFORM_BRONZE_TO_SILVER
WAREHOUSE = SAAS_WH
...
ALTER TASK SAAS_ANALYTICS.SILVER.TASK_TRANSFORM_BRONZE_TO_SILVER RESUME;

-- Display task details
DESCRIBE TASK SAAS_ANALYTICS.SILVER.TASK_TRANSFORM_BRONZE_TO_SILVER;
